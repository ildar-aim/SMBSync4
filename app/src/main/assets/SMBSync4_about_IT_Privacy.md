## 1.Dati raccolti  
### 1.1.Dati forniti dall'utente a SMBSync4  
...
- Password per proteggere i dati in "1.4.Invio o scrittura di dati al di fuori di SMBSync4"  
La password sarà scartata e non salvata al termine del processo.  

### 1.2.Risultato dell'esecuzione di SMBSync4  

Salva i dati nell'area di memorizzazione dell'applicazione in modo che l'utente possa controllare il risultato dell'esecuzione di SMBSync4.  
...
### 1.3.Registro delle attività di SMBSync4  
...
- Versione SMBSync4, opzioni di esecuzione SMBSync4  
- Nome della directory, nome del file, stato di esecuzione  
- Dimensione dei file sincronizzati, data e ora di aggiornamento dei file  
- Informazioni di debug  
- Informazioni di errore  

### 1.4.Invio o scrittura di dati al di fuori di SMBSync4  

<span style="color: red;"><u>I dati di SMBSync4 non possono essere inviati o scritti all'esterno a meno che non sia l'utente a farlo.</u></span>  
...
- Eseguendo "Impostazioni di esportazione" dal menu, "1.1.Dati forniti dall'utente a SMBSync4" saranno esportati.  
...
### 1.5.Cancellare i dati memorizzati in SMBSync4  

Disinstallando SMBSync4, i dati salvati ("1.1.Dati forniti dall'utente a SMBSync4", "1.2.Risultato dell'esecuzione di SMBSync4", "1.3.Registro delle attività di SMBSync4") saranno cancellati dal dispositivo.  
