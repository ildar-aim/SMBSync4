## 1. Collected data  
### 1.1.Data provided to SMBSync4 from users.  
...
- Password to protect data in "1.4. Send or export data outside SMBSync4"   
The password will be discarded and not saved when the process is finished.  

### 1.2.Execution result of SMBSync4  

Save the data to the storage area in the application so that the user can check the execution result of SMBSync4.  

- Directory name, file name, execution status  
- File size of synchronized files, file update date and time  
- Error information  

### 1.3.Activity log of SMBSync4  
...
- SMBSync4 version, SMBSync4 execution options  
- Directory name, file name, execution status  
- File size of synchronized files, file modification date and time  
- Debugging information  
- Error information  

### 1.4.Sending or writing data outside SMBSync4  

<span style="color: red;"><u></u></span>Data held by SMBSync4 cannot be sent or written out to outside unless operated by the user.  
...
- By executing "Export settings" from the menu, "1.1. Data provided to SMBSync4 from users" will be exported.  
...
### 1.5.Delete the data stored in SMBSync4  

By uninstalling SMBSync4, the saved data ("1.1. Data provided by user to SMBSync4", "1.2. Execution result of SMBSync4", "1.3.Activity log of SMBSync4") will be deleted from the device.  
