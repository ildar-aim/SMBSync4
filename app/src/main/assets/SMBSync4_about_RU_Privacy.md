## 1.Собранные данные  
### 1.1.Данные, предоставленные пользователем в SMBSync4  
...
- Пароль для защиты данных в "1.4.Отправка или запись данных за пределы SMBSync4"  
Пароль будет отброшен и не будет сохранен по завершении процесса.  

### 1.2.Результат выполнения SMBSync4  

Сохраните данные в области хранения в приложении, чтобы пользователь мог проверить результат выполнения SMBSync4.  

- Имя каталога, имя файла, статус выполнения  
- Размер синхронизированных файлов, дата и время обновления файлов  
- Информация об ошибках  

### 1.3.Журнал действий SMBSync4  
...
- Версия SMBSync4, параметры выполнения SMBSync4  
- Имя каталога, имя файла, статус выполнения  
- Размер синхронизированных файлов, дата и время обновления файлов  
- Информация об отладке  
- Информация об ошибках  

### 1.4.Отправка или запись данных за пределы SMBSync4  

<span style="color: red;"><u>Данные SMBSync4 не могут быть отправлены или записаны наружу, если пользователь не управляет ими.</u></span>  
...
- Выполнив команду "Экспорт списка задач" из меню, "1.1.Данные, предоставленные пользователем в SMBSync4" будут экспортированы.  
...
### 1.5.Удалить данные, хранящиеся в SMBSync4  

При удалении SMBSync4 сохраненные данные ("1.1.Данные, предоставленные пользователем в SMBSync4", "1.2.Результат выполнения SMBSync4", "1.3.Журнал действий SMBSync4") будут удалены с устройства.  
