## 1.Erfasste Daten  
### 1.1.Vom Benutzer an SMBSync4 bereitgestellte Daten  
...
- Passwort zum Schutz von Daten in "1.4.das Senden oder Schreiben von Daten außerhalb von SMBSync4"  
Das Passwort wird verworfen und nicht gespeichert, wenn der Vorgang beendet ist.  

### 1.2.Ausführungsergebnis von SMBSync4  

Speichern Sie die Daten im Speicherbereich in der Anwendung, damit der Benutzer das Ausführungsergebnis von SMBSync4 überprüfen kann.  
...
### 1.3.Aktivitätsprotokoll von SMBSync4  
...
- SMBSync4-Version, SMBSync4-Ausführungsoptionen  
- Verzeichnisname, Dateiname, Ausführungsstatus  
- Dateigröße der synchronisierten Dateien, Datum und Uhrzeit der Dateiaktualisierung  
- Informationen zur Fehlersuche  
- Fehlerinformation  

### 1.4.das Senden oder Schreiben von Daten außerhalb von SMBSync4  

<span style="color: red;"><u>SMBSync4-Daten können nur dann nach außen gesendet oder geschrieben werden, wenn der Benutzer sie bedient.</u></span>  
...
- Durch Ausführen von "Einstellungen exportieren" aus dem Menü wird "1.1.Vom Benutzer an SMBSync4 bereitgestellte Daten" exportiert werden.  
...
### 1.5.die in SMBSync4 gespeicherten Daten löschen  

Durch die Deinstallation von SMBSync4 werden die gespeicherten Daten ("1.1.Vom Benutzer an SMBSync4 bereitgestellte Daten", "1.2.Ausführungsergebnis von SMBSync4", "1.3.Aktivitätsprotokoll von SMBSync4") vom Gerät gelöscht.  
